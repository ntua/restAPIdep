...
while True:
    ...
    #print(f)
    try:        
        with open('input_files/'+f, 'r') as file:
...
with open('input_files/'+f, 'r') as file1:
    # read a list of lines into data
                        ...
                        for keychain in res_set:
                            if value in res_set[keychain]:
                                for tempid in res_id[keychain]:
                                    if id != tempid:
                                        if (tempid, id) not in endpoints_dep:
                                            endpoints_dep.add((tempid, id))
...
#     #print(f1)
#     try:        
#         with open('input_files/'+f1, 'r') as file3:
#             # read a list of lines into data
...
#print(compstr)
for k in endpoints_dep:
    print(k[0]+'  ------>  '+k[1])
# data3.append(compstr)
# fin = 'Dependencies_' + f1
# with open('output_files/'+fin, 'w') as file:
